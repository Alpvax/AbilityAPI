...
public interface IAbilityEffect
{
	 ...
	 * @param target The object affected by the power
	 */
	 ...
	 * Also called if the powers are removed from the provider, so the affected targets should be left in a state as
	 * though they didn't have powers.
	...
	/**
	 * Called every time the effect ticks (as determined by {@link #tickRate}).<br>
	...
	/**
	 * @return The number of game ticks to wait between ability ticks (i.e return 20 for the ability to
	 *         {@linkplain #tick} once per second)
	 */
	public int tickRate();
}