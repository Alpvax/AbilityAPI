...
{
	//TODO:Migrate to skillsandabilities package
	/**
	 ...
	 */
	//TODO:public void trigger(IAbilityProvider provider, IAbilityAffected target);
	 ...
	 * @param target The entity affected by the ability.
	 */
	//TODO:public void reset(IAbilityProvider provider, IAbilityAffected target);
	 ...
	 * @param target The entity affected by the ability.
	 */
	//TODO:public void tick(IAbilityProvider provider, IAbilityAffected target);
